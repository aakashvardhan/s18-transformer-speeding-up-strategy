...
class MultiHeadAttentionBlock(LightningModule):
    ...
    Methods:
        attention(query, key, value, mask, dropout): Performs attention calculation.
        forward(q, k, v, mask): Forward pass of the Multi-Head Attention Block.
    """
...
class Decoder(LightningModule):
    ...
    def forward(self, x, encoder_output: torch.Tensor, src_mask, tgt_mask):
        for layer in self.layers:
